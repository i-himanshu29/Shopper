...
// // Database cnnection with MONGODB
...
//     });
//     console.log(product);
//     await product.save();//save into db
//     console.log("saved");
//     res.json({
//         success:true,
//         name:req.body.name,
...
// //CREATINR API FOR DELETING PRODUCTS
...
// //creating and point for registering the user
...
// //creating endpoints to fetch user
